...
- (id)initWithFrame:(CGRect)frame itemOffset:(CGFloat)itemOffset imageArray:(NSArray *)images titleArray:(NSArray *)titles menuDelegate:(id<TYCircleMenuDelegate>)menudelegate {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        circleView = [[TYCircleView alloc]initWithFrame:CGRectMake(-circleRadious+(itemOffset+TYCircleCellSize.height/2)-TYDefaultItemPadding, TYCircleViewMargin+TYCircleViewMargin-TYDefaultItemPadding-50, (circleRadious+TYDefaultItemPadding)*2, (circleRadious+TYDefaultItemPadding)*2)];
//        circleCollectionView = [[TYCircleCollectionView alloc] initWithFrame:self.bounds itemOffset:itemOffset imageArray:images titleArray:titles];
        circleCollectionView = [[TYCircleCollectionView alloc] initWithFrame:CGRectMake(self.bounds.origin.x, self.bounds.origin.y-50, self.bounds.size.width, self.bounds.size.height) itemOffset:itemOffset imageArray:images titleArray:titles];
        ...
        UIButton *centerButton = [[UIButton alloc]initWithFrame:CGRectMake(10, self.bounds.size.height-70-40, 36, 36)];
